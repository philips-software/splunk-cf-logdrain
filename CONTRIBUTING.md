# Contributing to the splunk-cf-logdrain
...
If you have questions about how to use the HSDP terraform provider, please direct these to the #terraform channel on HSDP Slack or open a [discussion](https://github.com/philips-software/splunk-cf-logdrain/discussions).
...
In Github, send a pull request to original main branch: f.e. `splunk-cf-logdrain:main`.
...
[github]: https://github.com/philips-software/splunk-cf-logdrain/issues 
